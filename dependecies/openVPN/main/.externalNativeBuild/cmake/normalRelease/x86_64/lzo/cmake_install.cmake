...
file(INSTALL DESTINATION "/usr/local/lib" TYPE STATIC_LIBRARY FILES "/home/chaosruler/Desktop/m.s-aluminium-manager-app/src/openVPN/main/.externalNativeBuild/cmake/normalRelease/x86_64/lzo/liblzo2.a")
endif()
...
file(INSTALL DESTINATION "/usr/local/libexec/lzo/examples" TYPE EXECUTABLE FILES "/home/chaosruler/Desktop/m.s-aluminium-manager-app/src/openVPN/main/.externalNativeBuild/cmake/normalRelease/x86_64/lzo/lzopack")
  if(EXISTS "$ENV{DESTDIR}/usr/local/libexec/lzo/examples/lzopack" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/home/chaosruler/Android/Sdk/ndk-bundle/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-strip" "$ENV{DESTDIR}/usr/local/libexec/lzo/examples/lzopack")
    endif()
  endif()
endif()
...
file(INSTALL DESTINATION "/usr/local/libexec/lzo/examples" TYPE EXECUTABLE FILES "/home/chaosruler/Desktop/m.s-aluminium-manager-app/src/openVPN/main/.externalNativeBuild/cmake/normalRelease/x86_64/lzo/lzotest")
  if(EXISTS "$ENV{DESTDIR}/usr/local/libexec/lzo/examples/lzotest" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/home/chaosruler/Android/Sdk/ndk-bundle/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-strip" "$ENV{DESTDIR}/usr/local/libexec/lzo/examples/lzotest")
    endif()
  endif()
endif()
...
file(INSTALL DESTINATION "/usr/local/libexec/lzo/examples" TYPE EXECUTABLE FILES "/home/chaosruler/Desktop/m.s-aluminium-manager-app/src/openVPN/main/.externalNativeBuild/cmake/normalRelease/x86_64/lzo/simple")
  if(EXISTS "$ENV{DESTDIR}/usr/local/libexec/lzo/examples/simple" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/home/chaosruler/Android/Sdk/ndk-bundle/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-strip" "$ENV{DESTDIR}/usr/local/libexec/lzo/examples/simple")
    endif()
  endif()
endif()
...
file(INSTALL DESTINATION "/usr/local/libexec/lzo/examples" TYPE EXECUTABLE FILES "/home/chaosruler/Desktop/m.s-aluminium-manager-app/src/openVPN/main/.externalNativeBuild/cmake/normalRelease/x86_64/lzo/testmini")
  if(EXISTS "$ENV{DESTDIR}/usr/local/libexec/lzo/examples/testmini" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/home/chaosruler/Android/Sdk/ndk-bundle/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-strip" "$ENV{DESTDIR}/usr/local/libexec/lzo/examples/testmini")
    endif()
  endif()
endif()
...
file(INSTALL DESTINATION "/usr/local/lib/pkgconfig" TYPE FILE FILES "/home/chaosruler/Desktop/m.s-aluminium-manager-app/src/openVPN/main/.externalNativeBuild/cmake/normalRelease/x86_64/lzo/lzo2.pc")
endif()

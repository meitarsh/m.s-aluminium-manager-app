[app](../../index.md) / [com.example.chaosruler.msa_manager.MSSQL_helpers](../index.md) / [remote_inventory_table_helper](index.md) / [push_update](.)
...
`inventory` - the data-object we want to update and take the data from
